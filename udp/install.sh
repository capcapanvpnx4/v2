...
DB_URL="https://raw.githubusercontent.com/capcapanvpnx4/permission/main/regist"
...
# CONFIG
wget -qO /etc/zivpn/config.json https://raw.githubusercontent.com/capcapanvpnx4/v2/main/udp/config.json
